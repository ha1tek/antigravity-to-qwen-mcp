...
[![Version](https://img.shields.io/badge/Version-v1.0%20(Первый%20рабочий%20прототип)-blue.svg)](https://github.com/ha1tek/antigravity-to-qwen-mcp)
...
> **Автономный MCP-сервер для двухмодельной оркестрации разработки: Gemini в Google Antigravity (Оркестратор) + Qwen 3.8 Max (Субагент-исполнитель) через Chrome DevTools Protocol (CDP) или API.**
>
...
| Инструмент | Описание |
|---|---|
| `mcp_qwen_submit_task` | Делегирует задачу субагенту Qwen. Запускает задачу в фоне, возвращает `task_id`. |
